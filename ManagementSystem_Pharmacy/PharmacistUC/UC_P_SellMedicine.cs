...
namespace ManagementSystem_Pharmacy.PharmacistUC
{
    public partial class UC_P_SellMedicine : UserControl
    {
        ...
        private void UC_P_SellMedicine_Load(object sender, EventArgs e)
        {
            ...
            query = "select mname from medic where eDate > '3/2/2021' and quantity >'0'";
            ds= fn.getData(query);
        ...
        {
            listBoxMedicines.Items.Clear();
            query= "select mname from medic where mname like '"+txtSearch.Text+ "%'and eDate>'2/15/2021' and quantity>'0'";
            ds = fn.getData(query);
